...
{{- default .Chart.Name .Values.payments.nameOverride | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- if .Values.payments.fullnameOverride }}
{{- .Values.payments.fullnameOverride | trunc 63 | trimSuffix "-" }}
{{- else }}
{{- $name := default .Chart.Name .Values.payments.nameOverride }}
