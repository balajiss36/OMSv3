...
func (x *CheckItemsRequest) Reset() {
	*x = CheckItemsRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *CheckItemsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CheckItemsRequest) ProtoMessage() {}

func (x *CheckItemsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_oms_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CheckItemsRequest.ProtoReflect.Descriptor instead.
func (*CheckItemsRequest) Descriptor() ([]byte, []int) {
	return file_api_oms_proto_rawDescGZIP(), []int{5}
}

func (x *CheckItemsRequest) GetItems() []*ItemsWithQuantity {
	if x != nil {
		return x.Items
	}
	return nil
...
type CheckItemsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	IsStock bool    `protobuf:"varint,1,opt,name=IsStock,proto3" json:"IsStock,omitempty"`
	Items   []*Item `protobuf:"bytes,2,rep,name=Items,proto3" json:"Items,omitempty"`
}

func (x *CheckItemsResponse) Reset() {
	*x = CheckItemsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *CheckItemsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CheckItemsResponse) ProtoMessage() {}

func (x *CheckItemsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_oms_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CheckItemsResponse.ProtoReflect.Descriptor instead.
func (*CheckItemsResponse) Descriptor() ([]byte, []int) {
	return file_api_oms_proto_rawDescGZIP(), []int{6}
}

func (x *CheckItemsResponse) GetIsStock() bool {
	if x != nil {
		return x.IsStock
	}
	return false
...
func (x *CheckItemsResponse) GetItems() []*Item {
	if x != nil {
		return x.Items
	}
	return nil
...
var file_api_oms_proto_rawDesc = []byte{
	...
	0x03, 0x61, 0x70, 0x69, 0x22, 0x9c, 0x01, 0x0a, 0x05, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x18,
	...
	0x12, 0x1f, 0x0a, 0x05, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x09, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x05, 0x49, 0x74, 0x65, 0x6d,
	0x73, 0x12, 0x20, 0x0a, 0x0b, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x4c, 0x69, 0x6e, 0x6b,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x4c,
	0x69, 0x6e, 0x6b, 0x22, 0x4b, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52,
	...
	0x52, 0x05, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x22, 0x41, 0x0a, 0x11, 0x43, 0x68, 0x65, 0x63, 0x6b,
	0x49, 0x74, 0x65, 0x6d, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2c, 0x0a, 0x05,
	...
	0x69, 0x74, 0x79, 0x52, 0x05, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x22, 0x4f, 0x0a, 0x12, 0x43, 0x68,
	0x65, 0x63, 0x6b, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x12, 0x18, 0x0a, 0x07, 0x49, 0x73, 0x53, 0x74, 0x6f, 0x63, 0x6b, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x07, 0x49, 0x73, 0x53, 0x74, 0x6f, 0x63, 0x6b, 0x12, 0x1f, 0x0a, 0x05, 0x49, 0x74,
	0x65, 0x6d, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x09, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	...
	0x07, 0x49, 0x74, 0x65, 0x6d, 0x49, 0x44, 0x73, 0x22, 0x33, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x49,
	0x74, 0x65, 0x6d, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1f, 0x0a, 0x05,
	0x49, 0x74, 0x65, 0x6d, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x09, 0x2e, 0x61, 0x70,
	0x69, 0x2e, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x05, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x32, 0x97, 0x01,
	...
	0x61, 0x70, 0x69, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x2c, 0x0a, 0x08, 0x47, 0x65, 0x74,
	...
	,
	...
	0x61, 0x6c, 0x61, 0x6a, 0x69, 0x73, 0x73, 0x33, 0x36, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e,
...
var file_api_oms_proto_goTypes = []interface{}{
	...
	(*CheckItemsRequest)(nil),  // 5: api.CheckItemsRequest
	(*CheckItemsResponse)(nil), // 6: api.CheckItemsResponse
...
var file_api_oms_proto_depIdxs = []int32{
	...
	3,  // 2: api.CheckItemsRequest.Items:type_name -> api.ItemsWithQuantity
	2,  // 3: api.CheckItemsResponse.Items:type_name -> api.Item
	...
	1,  // 7: api.OrderService.GetOrder:input_type -> api.GetOrderRequest
	5,  // 8: api.StockService.CheckItems:input_type -> api.CheckItemsRequest
	7,  // 9: api.StockService.GetItems:input_type -> api.GetItemsRequest
	0,  // 10: api.OrderService.CreateOrder:output_type -> api.Order
	0,  // 11: api.OrderService.UpdateOrder:output_type -> api.Order
	0,  // 12: api.OrderService.GetOrder:output_type -> api.Order
	6,  // 13: api.StockService.CheckItems:output_type -> api.CheckItemsResponse
...
func file_api_oms_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_oms_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CheckItemsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_oms_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CheckItemsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
